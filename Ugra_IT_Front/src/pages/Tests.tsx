    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="bg-[#E9EEFF]">
          <div className="container px-[16px] mx-auto">
            <div className="flex flex-wrap items-center gap-[10px] justify-between p-[10px] mb-[120px] border border-[#0C1C35] rounded-[50px] mt-[60px]">
              <Button className="text-[28px] p-[20px]" variant={"ghost"}>
                Программирование
              </Button>
              <Button className="text-[28px]">Дизайн</Button>
